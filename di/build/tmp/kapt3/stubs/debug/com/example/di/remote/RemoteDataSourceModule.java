...
public final class RemoteDataSourceModule {
    ...
    @dagger.Provides()
    @javax.inject.Singleton()
    public final com.example.data.remote.datasource.RemoteMyPageDataSource bindRemoteMyPageDataModule(@org.jetbrains.annotations.NotNull()
    com.example.data.remote.api.MyPageAPI myPageAPI) {
        return null;
    }
}